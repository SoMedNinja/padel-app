...
export const editablePadelPuzzles: EditablePadelPuzzle[] = [
  ...
  },
  {
    ...
    type: "tap-to-target",
    title: "Svårast serve",
    scenario: "Du vill slå en serve som tvingar motståndaren att röra sig i sidled. Klicka på den bästa träffpunkten.",
    diagramUrl: "/education/rules-serve.svg",
    targetCoordinate: { x: 0.1, y: 0.8 },
    options: [
      { text: "Djupt nära sidogallret", isCorrect: true },
      { text: "Mitt i rutan", isCorrect: false },
      { text: "Kort och löst", isCorrect: false },
    ],
    coachingTip: "En serve djupt mot sidogallret tvingar motståndaren att anpassa sig efter glasstudsen.",
  },
  {
    questionId: "t5",
    difficulty: "hard",
    type: "tap-to-target",
    title: "Täck upp för partner",
    scenario: "Din partner (vänster) går fram för att smasha en kort lobb. Vart ska du (höger) placera dig för att täcka upp?",
    diagramUrl: "/education/movement-positions.svg",
    targetCoordinate: { x: 0.6, y: 0.4 },
    options: [
      { text: "Följ med framåt och täck mitten/höger", isCorrect: true },
      { text: "Stanna kvar vid baslinjen", isCorrect: false },
      { text: "Spring in i partnerns hörn", isCorrect: false },
    ],
    coachingTip: "När partnern går på attack ska du täcka den öppna ytan, ofta genom att flytta framåt.",
  },
  {
    questionId: "t6",
    difficulty: "easy",
    type: "tap-to-target",
    title: "Säkra mitten",
    scenario: "Ni har tappat nätet och måste försvara mitten. Vart ska du stå?",
    diagramUrl: "/education/defense-reset.svg",
    targetCoordinate: { x: 0.5, y: 0.85 },
    options: [
      { text: "Centralt nära baslinjen", isCorrect: true },
      { text: "Ute vid sidogallret", isCorrect: false },
      { text: "Framme vid nätet", isCorrect: false },
    ],
    coachingTip: "I försvar är mitten viktigast att stänga.",
  },
  {
    questionId: "t7",
    difficulty: "medium",
    type: "tap-to-target",
    title: "Attackera luckan",
    scenario: "Motståndarna har hamnat för långt bak. Klicka där du vill placera en stoppboll.",
    diagramUrl: "/education/offense-positions.svg",
    targetCoordinate: { x: 0.2, y: 0.2 },
    options: [
      { text: "Kort nära nätet", isCorrect: true },
      { text: "Djupt mot bakglas", isCorrect: false },
      { text: "Mot kroppen", isCorrect: false },
    ],
    coachingTip: "En stoppboll är effektivast när motståndarna är långt bak och förväntar sig en djup boll.",
  },
  {
    questionId: "t8",
    difficulty: "hard",
    type: "tap-to-target",
    title: "Vibora-placering",
    scenario: "Du slår en Vibora från vänster hörn. Klicka i motståndarens hörn där du vill att den ska dö.",
    diagramUrl: "/education/video-bandeja.svg",
    targetCoordinate: { x: 0.9, y: 0.9 },
    options: [
      { text: "Djupt i hörnet", isCorrect: true },
      { text: "Mitt i banan", isCorrect: false },
      { text: "Mot nätspelaren", isCorrect: false },
    ],
    coachingTip: "Viboran ska pressa motståndaren djupt ner i hörnet med låg studs.",
  },
  {
    questionId: "p1",
    difficulty: "easy",
    title: "Skottval vid nät",
    scenario: "Titta på diagrammet. Du har fått en hög boll att smasha (röd linje). Vad är risken?",
    diagramUrl: "/education/padel-shots.svg",
    options: [
      { text: "Att slå för löst så motståndaren hinner fram.", isCorrect: false },
      { text: "Att missa gallret.", isCorrect: false },
      { text: "Att bollen studsar ut för mycket från bakglas om du inte slår ut den.", isCorrect: true },
    ],
    coachingTip: "En smash som inte dödar poängen ger motståndaren ett enkelt kontringsläge.",
  },
  {
    questionId: "p2",
    difficulty: "medium",
    title: "Rotation i Mexicana",
    scenario: "I en Mexicana-turnering (se diagram), hur bestäms nästa motståndare?",
    diagramUrl: "/education/mexicana-rotation.svg",
    options: [
      { text: "Baserat på aktuell rankingtabell.", isCorrect: true },
      { text: "Helt slumpmässigt.", isCorrect: false },
      { text: "Man byter bara partner.", isCorrect: false },
    ],
    coachingTip: "Mexicana bygger på att jämnbördiga spelare möts baserat på poängställningen.",
  },
  {
    questionId: "p3",
    difficulty: "easy",
    title: "Poängräkning Americano",
    scenario: "Se poängtavlan. Hur många poäng delar man på totalt i en Americano-match?",
    diagramUrl: "/education/americano-scoreboard.svg",
    options: [
      { text: "Ett bestämt antal, t.ex. 32 poäng.", isCorrect: true },
      { text: "Först till 6 gem.", isCorrect: false },
      { text: "Vanlig tennisräkning (15, 30, 40).", isCorrect: false },
    ],
    coachingTip: "I Americano spelar man om varje boll upp till en förutbestämd totalsumma.",
  },
  {
    questionId: "p4",
    difficulty: "medium",
    title: "Position vid egen serve",
    scenario: "Diagrammet visar servarens position. Vad ska servaren göra direkt efter tillslaget?",
    diagramUrl: "/education/video-serve.svg",
    options: [
      { text: "Snabbt ta sig fram till nätposition.", isCorrect: true },
      { text: "Stanna kvar vid baslinjen.", isCorrect: false },
      { text: "Röra sig i sidled mot mitten.", isCorrect: false },
    ],
    coachingTip: "Serve är enda gången du garanterat kan ta nätet. Utnyttja det!",
  },
  {
    questionId: "p5",
    difficulty: "hard",
    title: "Lobba över smashare",
    scenario: "Motståndaren står redo att smasha (se bild). Vilken typ av lobb är mest riskabel här?",
    diagramUrl: "/education/video-bandeja.svg",
    options: [
      { text: "En kort och låg lobb.", isCorrect: true },
      { text: "En hög och djup lobb.", isCorrect: false },
      { text: "En ballonglobb.", isCorrect: false },
    ],
    coachingTip: "En kort lobb ger motståndaren ett gratis smashläge.",
  },
  {
    questionId: "q1",
    difficulty: "easy",
    title: "Golden Point",
    scenario: "Ställningen är 40-40 (Deuce). Vad gäller vid Golden Point?",
    options: [
      { text: "Nästa poäng avgör gemet. Mottagarna väljer sida.", isCorrect: true },
      { text: "Man måste vinna med två bollar.", isCorrect: false },
      { text: "Servaren väljer sida.", isCorrect: false },
    ],
    coachingTip: "Golden Point infördes för att snabba upp spelet och öka spänningen.",
  },
  {
    questionId: "q2",
    difficulty: "medium",
    title: "Serve i glaset",
    scenario: "Du servar och bollen träffar sidogallret direkt efter studs i serverutan. Domsalut?",
    options: [
      { text: "Felserve (Out).", isCorrect: true },
      { text: "Giltig serve.", isCorrect: false },
      { text: "Omspel.", isCorrect: false },
    ],
    coachingTip: "Serven får studsa i glaset, men aldrig i gallret.",
  },
  {
    questionId: "q3",
    difficulty: "medium",
    title: "Bollträff på spelare",
    scenario: "Du smashar hårt och bollen träffar motståndaren på benet utan att ha studsat. Vem vinner poängen?",
    options: [
      { text: "Du vinner poängen.", isCorrect: true },
      { text: "Motståndaren vinner poängen.", isCorrect: false },
      { text: "Omspel.", isCorrect: false },
    ],
    coachingTip: "Om bollen rör en spelare innan den studsar räknas det som att spelaren förlorar poängen.",
  },
  {
    questionId: "q4",
    difficulty: "hard",
    title: "Röra nätet",
    scenario: "Du springer fram och slår en vinnande stoppboll, men din fot snuddar vid nätet innan bollen studsat två gånger.",
    options: [
      { text: "Du förlorar poängen.", isCorrect: true },
      { text: "Du vinner poängen eftersom slaget var klart.", isCorrect: false },
      { text: "Omspel.", isCorrect: false },
    ],
    coachingTip: "Du får aldrig röra nätet medan bollen är i spel.",
  },
  {
    questionId: "q5",
    difficulty: "hard",
    title: "Slå på motståndarens sida",
    scenario: "Bollen studsar på din sida och skruvar tillbaka över nätet. Får du sträcka dig över nätet och slå den?",
    options: [
      { text: "Ja, så länge du inte rör nätet.", isCorrect: true },
      { text: "Nej, racketen får aldrig vara över nätet.", isCorrect: false },
      { text: "Bara om du slår den rakt ner.", isCorrect: false },
    ],
    coachingTip: "Detta är det enda undantaget då du får spela bollen på motståndarens sida.",
  },
];
