  ...
  if (!user && !isGuest) {
    return (
      <Auth
        onAuth={() => {
          setIsGuest(false);
          // Note for non-coders: we don't call refresh() here because onAuthStateChange
          // in useAuthProfile will automatically pick up the new session and sync the profile.
        }}
